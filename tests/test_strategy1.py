...
from tests.test_data import valid_inputs, invalid_inputs, infix_to_postfix, eval_postfix

class TestStrategy1(TestCase):
    
    def test_eval_with_valid_inputs(self):
        strategy = Strategy1()
        test_data = valid_inputs.parse()
    ...
    def test_eval_with_invalid_inputs(self):
        strategy = Strategy1()
        test_data = invalid_inputs.parse()
